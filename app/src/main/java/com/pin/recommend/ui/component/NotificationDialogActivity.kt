...
class NotificationDialogFragment(val data: NotificationData) : DialogFragment() {
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        val view = requireActivity().layoutInflater.inflate(R.layout.dialog_new_app_release, null)

        view.findViewById<TextView>(R.id.title).setText(data.title)
        view.findViewById<ImageView>(R.id.icon).setImageResource(data.icon)
        view.findViewById<TextView>(R.id.message).setText(data.message)
