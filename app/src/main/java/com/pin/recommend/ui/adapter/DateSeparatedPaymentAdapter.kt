    ...
    inner class PaymentRecyclerViewAdapter : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
        ...
        override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
            ...
            holder.containerView.setOnClickListener {
                val intent = Intent(holder.itemView.context, PaymentEditActivity::class.java)
                intent.putExtra(PaymentEditActivity.INTENT_EDIT_PAYMENT, paymentAndTag.payment.id)
