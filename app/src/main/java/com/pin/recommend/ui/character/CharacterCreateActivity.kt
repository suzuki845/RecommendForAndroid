...
class CharacterCreateActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            Body(
                ...
                requestCodeEditAnniversary = REQUEST_CODE_EDIT_ANNIVERSARY
            )
        }
    }
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, result: Intent?) {
        ...
        if (requestCode == REQUEST_CODE_CREATE_ANNIVERSARY && resultCode == RESULT_OK) {
            result?.let {
                it.getStringExtra(AnniversaryCreateActivity.INTENT_CREATE_ANNIVERSARY)?.let {
        ...
        if (requestCode == REQUEST_CODE_EDIT_ANNIVERSARY && resultCode == RESULT_OK) {
            result?.let {
                it.getStringExtra(AnniversaryEditActivity.INTENT_EDIT_ANNIVERSARY)?.let {
                    val anniversary = CustomAnniversary.Draft.fromJson(it ?: "")
